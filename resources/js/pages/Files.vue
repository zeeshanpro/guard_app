<template>
    ...
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="small-box">
                    <button @click="openModal" type="button" class="btn btn-primary"><i class="fas fa-plus"></i> Create Folder</button>
                                ...
                                <tbody style="">
                                    <tr v-for="folder in folders">
                                        ...
                                        <td>
                                            ...
                                            <router-link :to="{name: 'FileList', params: {id: folder.id}}"><i class="fas fa-folder">&nbsp;&nbsp;{{ folder.name}}</i></router-link>
                                            </div>
                                        </td>
